...
#   1.0.12       - 版本号（用于 version 字段，如 "0.0.1"）
#   tag - 安装类型: "tag" 或 "branch"
#   v1.0.12  - 版本引用: tag 名称（如 "v0.0.1"）或 branch 名称（如 "main"）
class Workflow < Formula
  ...
  on_macos do
    ...
    # - 如果 tag == "tag"，则替换为: url "...", tag: "v1.0.12"
    # - 如果 tag == "branch"，则替换为: url "...", branch: "v1.0.12"
    #
    ...
    #   fi
    url "https://github.com/zevwings/workflow.rs.git", tag: "v1.0.12"
    # 示例（构建脚本会生成以下之一）:
