...
#   1.5.11       - 版本号（用于 version 字段，如 "0.0.1"）
#   tag - 安装类型: "tag" 或 "branch"
#   v1.5.11  - 版本引用: tag 名称（如 "v0.0.1"）或 branch 名称（如 "main"）
class Workflow < Formula
  ...
  on_macos do
    ...
    # - 如果 tag == "tag"，则替换为: url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.9/workflow-1.6.9-x86_64-apple-darwin.tar.gz"
    # - 如果 tag == "branch"，则替换为: url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.9/workflow-1.6.9-x86_64-apple-darwin.tar.gz"
    #
    ...
    #   fi
    url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.9/workflow-1.6.9-x86_64-apple-darwin.tar.gz"
    # 示例（构建脚本会生成以下之一）:
    #   url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.9/workflow-1.6.9-x86_64-apple-darwin.tar.gz"
    #   或
    #   url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.9/workflow-1.6.9-x86_64-apple-darwin.tar.gz"
  ...
  def post_install
    ...
    if install_binary.exist? && install_binary.executable?
      ...
      # 参考 Makefile: ./target/release/install --completions
      result = system(install_binary.to_s, "--completions")
      ...
      if result
        ...
        opoo "  #{install_binary} --completions"
        opoo "Or use the workflow command:"
        opoo "  workflow update"
      end
    else
