...
#   v0.0.1-alpha.002       - 版本号（用于 version 字段，如 "0.0.1"）
#   branch - 安装类型: "tag" 或 "branch"
#   zw/update-completions  - 版本引用: tag 名称（如 "v0.0.1"）或 branch 名称（如 "main"）
class Workflow < Formula
  ...
  on_macos do
    ...
    # - 如果 branch == "tag"，则替换为: url "...", tag: "zw/update-completions"
    # - 如果 branch == "branch"，则替换为: url "...", branch: "zw/update-completions"
    #
    ...
    #   fi
    url "https://github.com/zevwings/workflow.rs.git", branch: "zw/update-completions"
    # 示例（构建脚本会生成以下之一）:
