...
#   0.0.0-dev       - 版本号（用于 version 字段，如 "0.0.1"）
#   branch - 安装类型: "tag" 或 "branch"
#   master  - 版本引用: tag 名称（如 "v0.0.1"）或 branch 名称（如 "main"）
class Workflow < Formula
  ...
  on_macos do
    ...
    # - 如果 branch == "tag"，则替换为: url "...", tag: "master"
    # - 如果 branch == "branch"，则替换为: url "...", branch: "master"
    #
