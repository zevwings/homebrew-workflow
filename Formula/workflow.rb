...
class Workflow < Formula
  ...
  on_macos do
    ...
    # - 如果 tag == "tag"，则替换为: url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.0/workflow-1.6.0-x86_64-apple-darwin.tar.gz"
    # - 如果 tag == "branch"，则替换为: url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.0/workflow-1.6.0-x86_64-apple-darwin.tar.gz"
    #
    ...
    #   fi
    url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.0/workflow-1.6.0-x86_64-apple-darwin.tar.gz"
    # 示例（构建脚本会生成以下之一）:
    #   url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.0/workflow-1.6.0-x86_64-apple-darwin.tar.gz"
    #   或
    #   url "https://github.com/zevwings/workflow.rs/releases/download/v1.6.0/workflow-1.6.0-x86_64-apple-darwin.tar.gz"
